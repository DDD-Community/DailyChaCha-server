...
var UserExerciseHistoryColumns = struct {
	...
	ExerciseEndedAt:   "exercise_ended_at",
}
...
var UserExerciseHistoryTableColumns = struct {
	...
	ExerciseStartedAt: "user_exercise_histories.exercise_started_at",
	ExerciseEndedAt:   "user_exercise_histories.exercise_ended_at",
}
...
var UserExerciseHistoryWhere = struct {
	...
	ExerciseStartedAt whereHelpertime_Time
	ExerciseEndedAt   whereHelpernull_Time
}{
	...
	ExerciseStartedAt: whereHelpertime_Time{field: "`user_exercise_histories`.`exercise_started_at`"},
	ExerciseEndedAt:   whereHelpernull_Time{field: "`user_exercise_histories`.`exercise_ended_at`"},
}
...
var (
	userExerciseHistoryAllColumns            = []string{"id", "user_id", "exercise_date", "exercise_started_at", "exercise_ended_at"}
	userExerciseHistoryColumnsWithoutDefault = []string{"user_id", "exercise_date", "exercise_started_at", "exercise_ended_at"}
...
func UserExerciseHistories(mods ...qm.QueryMod) userExerciseHistoryQuery {
	...
	return userExerciseHistoryQuery{NewQuery(mods...)}
}
