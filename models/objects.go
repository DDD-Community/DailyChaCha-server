...
func Objects(mods ...qm.QueryMod) objectQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`objects`.*"})
	}

	return objectQuery{q}
}

// FindObject retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindObject(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Object, error) {
	objectObj := &Object{}
	...
	if err = objectObj.doAfterSelectHooks(ctx, exec); err != nil {
		return objectObj, err
	}
...
func ObjectExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
